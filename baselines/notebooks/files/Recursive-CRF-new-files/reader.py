...
PUBMED_WORD2VEC_FILE = "./embeddings/PubMed-shuffle-win-30.bin"
germ = "./embeddings/de-crawl.bin"
wl = "./embeddings/cwlce.bin"
...
class Reader:
    ...
    @staticmethod
    def gen_vectors_germ_word2vec(embed_path: str) -> None:
        shutil.copyfile(germ, embed_path)
    
    @staticmethod
    def gen_vectors_wl_word2vec(embed_path: str) -> None:
        shutil.copyfile(wl, embed_path)
